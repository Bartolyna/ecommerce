    ...
    <div class="container" style="margin-top: 80px">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-7">
                ...
                @else
                    <h4>No tiene Producto(s) </h4><br>
                    <a href="/" class="btn btn-dark">Continue Comprando</a>
                @endif
                ...
                @foreach($carritoCollection as $item)
                    <div class="row">
                        ...
                        <div class="col-lg-5">
                            <p>
                                <b><a href="/tienda/{{ $item->attributes->slug }}">{{ $item->name }}</a></b><br>
            ...
            @if(count($carritoCollection)>0)
                <div class="col-lg-5">
                    ...
                    <br><a href="/" class="btn btn-dark">Continue Comprando</a>
